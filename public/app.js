(function () {
  var state = { user: null, date: null, today: null, startDate: null, puzzle: null, selected: null, shareId: null, authMode: "login" };
  ...
  function showScreen(screen) {
    ...
    el("play-screen").hidden = !!profile;
    el("profile-screen").hidden = !profile;
    el("play-button").classList.toggle("active", !profile);
